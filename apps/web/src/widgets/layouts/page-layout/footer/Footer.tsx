import { footerData } from '@src/widgets/layouts/page-layout/footer/footer-data.ts'
import FooterRow from '@src/widgets/layouts/page-layout/footer/FooterRow.tsx'

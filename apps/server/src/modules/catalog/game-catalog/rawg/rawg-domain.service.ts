...
import type { GetAllGenresInput } from '@src/modules/catalog/game-catalog/rawg/shared/inputs/get-all-genres.input'
import type { GetAllPlatformsInput } from '@src/modules/catalog/game-catalog/rawg/shared/inputs/get-all-platforms.input'

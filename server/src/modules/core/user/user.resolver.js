...
var UserResolver = function () {
    ...
    var UserResolver = _classThis = /** @class */ (function () {
        ...
        UserResolver_1.prototype.getUser = function (input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userService.getByEmail(input)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        UserResolver_1.prototype.updateUser = function (user, input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userService.update(user.sub, input)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        UserResolver_1.prototype.deleteUser = function (user, input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userService.delete(user.sub, input)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    (function () {
        ...
        _getUser_decorators = [(0, graphql_1.Query)(function () { return user_type_1.User; }, { nullable: true, name: 'getUser' })];
        _updateUser_decorators = [(0, graphql_1.Mutation)(function () { return user_type_1.User; }, { name: 'updateUser' })];
        _deleteUser_decorators = [(0, graphql_1.Mutation)(function () { return user_type_1.User; }, { name: 'deleteUser' })];
